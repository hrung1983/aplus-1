...
?>
  <tr>
    ...
    <td><font color="<?php echo $fontcolor;?>"><?php echo @$data["password"]?></font></td>
    <td><font color="<?php echo $fontcolor;?>"><?php echo @@$data["tel"]?></font></td>
    <td><font color="<?php echo $fontcolor;?>"><?php echo $data["status_position"]?></font></td>
    <td><font color="<?php echo $fontcolor;?>"><?php if(@$data["status_active"]=="y") echo "ใช้งานปกติ"; else "ยกเลิก"; ?></font></td>
    <td>
      <a href="employee.entry.php?id=<?php echo @$data["id"]?>"><button type="button" class="btn btn-info btn-xs" title="Edit"><i class="glyphicon glyphicon-pencil"></i></button></a>
    </td>
  </tr>
<?php } ?>
</table>
